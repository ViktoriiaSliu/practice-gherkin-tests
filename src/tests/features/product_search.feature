...
@search @smoke
  Scenario: Search for an Existing Product
    ...
    When I enter the "Hammer" product name in the search bar
    And I click the search icon
    Then I should see all the "Hammer" product name in the results

@view @smoke
  Scenario: View Details for Bolt Cutters
    Given I am on the product listing page
    When I select the "Bolt Cutters" product
    Then I should see the "Bolt Cutters" product title
