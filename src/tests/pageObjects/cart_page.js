...
class CartPage extends BasePage {
  ...
  get proceedToCheckoutBtnCart() {
    return $('button[data-test="proceed-1"]');
  }
  get proceedToCheckoutBtnLogin() {
    return $('button[data-test="proceed-2"]');
  }
  get proceedToCheckoutBtnBill() {
    return $('button[data-test="proceed-3"]');
  }
  ...
  get confirmMessage() {
    return $('p[class="ng-star-inserted"]');
  }

  get billingHeader() {
    return $('h3=Billing Address');
  }
  get streetInput() {
  ...
  get countryInput() {
    return $('input[data-test="country"]');
  }
  get postcodeInput() {
  ...
  get creditCardOption() {
    return $('option[value="credit-card"]');
  }
  get cardNumberInput() {
  ...
  get paymentSuccessMessage() {
    return $('div[data-test="payment-success-message"]');
  }
  ...
  async fillPaymentDetails(card) {
    await this.paymentMethodDropdown.waitForClickable({
