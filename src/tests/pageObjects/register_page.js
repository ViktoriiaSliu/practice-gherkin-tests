...
class RegisterPage extends BasePage {
    ...
    get firstNameInput() { return $('input[formcontrolname="first_name"]'); }
    get lastNameInput() { return $('input[formcontrolname="last_name"]'); }
    get dateOfBirthInput() { return $('input[formcontrolname="dob"]'); }
    ...
    get countryInput() { return $('select[formcontrolname="country"]'); }
